...
$(document).ready(function() {
	...
	function VM() {
		...
		ko.computed(function() {
			...
			$('body').append('<script id="mathjax" type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.0/MathJax.js?config=TeX-AMS-MML_HTMLorMML.js"></script>');
